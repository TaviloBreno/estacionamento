...
class Mensalidades_model extends CI_Model
{
	public function get_all()
	{
		...
		$this->db->join('precificacoes', 'precificacao_id = mensalidades.mensalidade_precificacao_id', 'LEFT');
		$this->db->join('mensalistas', 'mensalista_id = mensalidades.mensalidade_mensalista_id', 'LEFT');
